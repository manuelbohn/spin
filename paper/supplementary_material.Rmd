...
where $P_{ME}(r \mid u; \{\alpha_i, \theta_{ij}\})$ represents a mutual-exclusivity inference from a listener with a uniform prior on referents. $P_{S_1}(u \mid r; \{\alpha_i, \theta_{ij}\}$ is the same as in Eq. \@ref(eq:rsafull) above.
