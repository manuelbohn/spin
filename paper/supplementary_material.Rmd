...
```{r fig10, include = T, fig.cap = "Bias parameter for the biased model (A) and the developmental bias model (B). (A) shows the posterior distribution of the bias parameter and (B) shows developmental trajectories for the bias parameter based on 300 random draws from the posterior distribution for intercept and slope.", fig.width=10, fig.height = 4, }
...
```{r figa1, include = T, cache=F,  fig.cap = "Posterior distribution of intercept and slope term for semantic knowledge for each object by model.", fig.width=12, fig.height = 5}
