...
To generate model predictions for the rational integration model we combined the parameters according to the model formula (Fig. 1F). As mentioned above, common ground information could either be aligned or in conflict with the other information sources. In the congruent condition, the novel object was also the discourse novel object and thus had the prior probability $\rho$. In the incongruent condition, the novel object was the "old" object and thus had the prior probability of $1 - \rho$.
