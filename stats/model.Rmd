...
sem_know_model <- readRDS("../saves/sem_know_model_variant3_50k.rds")
...
ggsave("../graphs/overview_variant_3_50k.png", width = 12, height = 4, scale = 1.2)
...
saveRDS(sem_know_model, "../saves/sem_know_model_variant3_50k.rds")
