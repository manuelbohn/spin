...
var model  = function(){
  ...
  var globalLineParameters = {
    intercept: uniformDrift({a: -3, b: 3, width: 1}),
    slope: uniformDrift({a: 0, b: 3, width: 1})
  }
...
### Comparing sem knowledge parameters between model runs
...
ggsave("../graphs/model_by_chain_run.pdf", width = 10, height = 8)
```
