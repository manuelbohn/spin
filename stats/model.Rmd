...
devtools::install_github("https://github.com/mhtess/webppl-sample-writer")
...
var callback = webpplSampleWriter.streamQueryCSV("../saves/samples.csv", header);
...
model <- read_csv("../saves/samples.csv")
