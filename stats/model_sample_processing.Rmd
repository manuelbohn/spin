...
model <- bind_rows(
 fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain4.csv",header = T)%>%mutate(chain = 1),
fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain4.csv",header = T)%>%mutate(chain = 2), 
fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain4.csv",header = T)%>%mutate(chain = 3),
 fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain5.csv",header = T)%>%mutate(chain = 4),
 fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain6.csv",header = T)%>%mutate(chain = 5)
)
...
saveRDS(global_params, "../saves/global_params_2.rds")
...
saveRDS(item_sigma, "../saves/item_sigma_2.rds")
...
saveRDS(model_pred_prag, "../saves/model_pred_prag_2.rds")
