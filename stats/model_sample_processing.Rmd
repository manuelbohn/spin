...
model <- bind_rows(
 fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain4.csv",header = T)%>%mutate(chain = 4),
 fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain5.csv",header = T)%>%mutate(chain = 5),
 fread("../webppl/output/samples-reFactor-noRandomEffects_mcmc-100000_burn50000_lag5_chain6.csv",header = T)%>%mutate(chain = 6)
)
...
saveRDS(item_params, "../saves/item_params_2.rds")
